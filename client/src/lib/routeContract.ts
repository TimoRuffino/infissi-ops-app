...
export const APP_ROUTE_CONTRACT = [
  ...
  route({
    ...
    kind: "page",
    target: "Economia",
    uxGuard: "navigation:direzione|amministrazione",
    serverAuthority: "ficFattureRouter + ficCostiRouter + commesseRouter",
    requiredCapabilities: ["economia.read"],
    roleRule: "direzione | amministrazione",
    featureFlag: null,
    navigation: "primary",
    mobileTreatment: "workbench",
    migrationStatus: "planned",
  ...
  route({
    ...
    serverAuthority: "commesseRouter + server role guard",
    requiredCapabilities: ["economia.read"],
    roleRule: "direzione",
    featureFlag: null,
    navigation: "primary",
  ...
  route({
    ...
    target: "GaranzieList",
    uxGuard: "RequireDirezione",
    serverAuthority: "garanzieRouter + adminProcedure",
    requiredCapabilities: [],
    roleRule: "direzione",
    featureFlag: null,
    navigation: "hidden",
  ...
  route({
    ...
    uxGuard: "RequireDirezione",
    serverAuthority: "fornitoriRouter + proposal approval gateway",
    requiredCapabilities: [
  ...
  route({
    ...
    target: "UtentiList",
    uxGuard: "RequireDirezione",
    serverAuthority: "utentiRouter + adminProcedure",
    requiredCapabilities: [],
    roleRule: "direzione",
    featureFlag: null,
    navigation: "primary",
  ...
  route({
    ...
    target: "SediList",
    uxGuard: "RequireDirezione",
    serverAuthority: "sediRouter + adminProcedure",
    requiredCapabilities: [],
    roleRule: "direzione",
    featureFlag: null,
    navigation: "primary",
  ...
  route({
    ...
    target: "Conoscenza",
    uxGuard: "RequireDirezione",
    serverAuthority: "conoscenzaRouter + server role checks",
    requiredCapabilities: [],
    roleRule: "direzione",
    featureFlag: null,
    navigation: "hidden",
