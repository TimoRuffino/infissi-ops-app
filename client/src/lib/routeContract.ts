...
export const APP_ROUTE_CONTRACT = [
  ...
  route({
    path: "/commesse/:id/limiti/stampa",
    kind: "page",
    target: "LimitiStampa",
    uxGuard: "capability:contratto.read",
    serverAuthority: "computoRouter.ultimo + contrattiRouter.get + procedureConInterruttore(limiti)",
  ...
  route({
    ...
    serverAuthority: "invitiRouter.anteprima/accetta (token monouso a scadenza)",
  ...
  route({
    ...
    kind: "redirect",
    target: "/fornitori",
    uxGuard: "LegacyRedirect",
    serverAuthority: "redirect only; le conferme vivono in Fornitori",
    requiredCapabilities: [],
    roleRule: null,
    featureFlag: null,
    navigation: "redirect",
  ...
  route({
    ...
    uxGuard: "LegacyRedirect",
    serverAuthority:
      "redirect only; le garanzie restano nella scheda cliente (garanzieRouter)",
    requiredCapabilities: [],
    roleRule: null,
    featureFlag: null,
    navigation: "redirect",
  ...
  route({
    ...
    uxGuard: "authenticated shell",
    serverAuthority:
      "fornitoriRouter.archivio (sede scope); collega/scarta richiedono direzione o amministrazione",
    requiredCapabilities: ["commessa.read"],
    roleRule: null,
    featureFlag: null,
    navigation: "primary",
  ...
  route({
    ...
    kind: "guarded",
    target: "AziendeList",
    uxGuard: "RequirePiattaforma",
    serverAuthority: "piattaformaRouter.aziende (piattaformaProcedure)",
    requiredCapabilities: [],
    roleRule: null,
    featureFlag: null,
    navigation: "hidden",
  ...
  route({
    ...
    kind: "guarded",
    target: "AziendaDetail",
    uxGuard: "RequirePiattaforma",
    serverAuthority: "piattaformaRouter.azienda (piattaformaProcedure)",
    requiredCapabilities: [],
    roleRule: null,
    featureFlag: null,
    navigation: "hidden",
