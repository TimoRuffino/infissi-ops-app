  ...
  return (
    <div className="min-w-0 space-y-4 sm:space-y-5">
      <PageHeader
        ...
        description="Calcolatori di preventivo per azienda e prodotto. Apri quello pronto: misure, listino, riepilogo e PDF restano dentro Wyndoor."
        metadata={
          <>
            <span>
        ...
        <>
          ...
          {nonDisponibili.length > 0 ? (
            <DataSurface
              density="compact"
              tone="default"
              title="Non disponibili in Wyndoor"
