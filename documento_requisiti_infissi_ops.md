...
**Stato:** Documento vivente, riallineato allo stato corrente del checkout (01/09/2026).
**Versione:** 5.29 - Tars v2 è operativo e proattivo in produzione col
provider reale; i tetti di spesa sono stati eliminati su decisione della
direzione (gate OpenAI §8) mantenendo intatta la contabilità del governor.
