...
**Versione:** 5.14 - Tars v2 in costruzione su `feature/tars-v2` (mai in produzione: flag fail-closed spenti): T1 runtime read-only, T2 promemoria personali L1 e T3 fascicoli/cache/pannello contestuale completati con test; contratti vincolanti in docs/tars/architettura-tars-v2.md (§54 progetto attivo). Le sezioni sull'agente descrivono soltanto storia (§50), predisposizioni spente (§53) e progetto in corso (§54).
