...
**Versione:** 5.16 - Tars v2 in costruzione su `feature/tars-v2` (mai in produzione: flag fail-closed spenti): T1 runtime read-only, T2 promemoria L1, T3 fascicoli/cache/pannello, T4 briefing/shadow e T5 azioni L2 + gateway L3 a conferma unica completati con test; contratti vincolanti in docs/tars/architettura-tars-v2.md (§54 progetto attivo). Le sezioni sull'agente descrivono soltanto storia (§50), predisposizioni spente (§53) e progetto in corso (§54).
