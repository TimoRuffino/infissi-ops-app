...
**Versione:** 5.18 - Tars v2 in costruzione su `feature/tars-v2` (mai in produzione: flag fail-closed spenti): slice T1-T7 completate con test (runtime, promemoria L1, fascicoli/cache, briefing/shadow, azioni L2+gateway L3, documenti/comunicazioni, memoria); C5 semantica e invio L4 differiti ai gate della direzione; contratti vincolanti in docs/tars/architettura-tars-v2.md (§54 progetto attivo). Le sezioni sull'agente descrivono soltanto storia (§50), predisposizioni spente (§53) e progetto in corso (§54).
