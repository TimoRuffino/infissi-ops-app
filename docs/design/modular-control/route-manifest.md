...
| -------------------------------------------------- | --------------------------------------- | -------------------------------- | ------------------------------------------------------------ | ---------------------------------------------------------------------------- | ---------------- | ----------- | ------------------------------------------------------------------------- | --------------------------------- | -------- |
| /fatture/:id/stampa                                | page · FatturaStampa                    | capability:fattura.read          | fattureRouter.byId + procedureConInterruttore(limiti)       | fattura.read; pagina senza shell, aperta in scheda nuova                     | hidden deep link | record      | — (stampa fattura anche in bozza · 05/09)                                 | 05/09 · verifica browser in sospeso | migrata  |
| /commesse/:id/limiti/stampa                                | page · LimitiStampa                    | capability:contratto.read          | computoRouter.ultimo + contrattiRouter.get + procedureConInterruttore(limiti)       | contratto.read; pagina senza shell, aperta in scheda nuova                     | hidden deep link | record      | — (stampa del computo dei limiti · 07/09)                                 | 07/09 · verifica browser in sospeso | migrata  |
| /invito/:token                                     | page · InvitoPage                       | none (pagina pubblica, senza shell) | invitiRouter.anteprima/accetta (token monouso a scadenza)    | nessuna; il token è l'unico segreto, monouso e a scadenza (WS6 §6.3)         | hidden deep link | record      | — (invito del proprietario · 09/09)                                       | 09/09 · verifica browser 390x844  | migrata  |
| /prova                                             | page · ProvaPage                        | none (pagina pubblica, senza shell) | iscrizioneRouter.disponibile/registra (FLAG_ISCRIZIONE_PUBBLICA + posta configurata, limite per indirizzo) | nessuna; risposta sempre generica, link d'invito solo per email (ciclo di vita §60.14) | hidden deep link | record      | — (iscrizione pubblica · 10/09)                                           | 10/09 · verifica browser 390x844  | migrata  |
...
| /fatturazione                                      | page · Fatturazione                     | capability:contratto.read        | fatturazioneGuidataRouter + procedureConInterruttore(limiti) | contratto.read; hidden with FLAG_LIMITI off                                  | primary          | standard    | — (fatturazione guidata, piano 4 · 05/09)                                 | 05/09 · verifica browser in corso | migrata  |
| /fatturazione/:id                                  | page · FatturazioneCommessa             | capability:contratto.read        | fatturazioneGuidataRouter + procedureConInterruttore(limiti) | contratto.read; hidden with FLAG_LIMITI off                                  | hidden deep link | record      | — (percorso a passi, piano 4 · 05/09)                                     | 05/09 · verifica browser in corso | migrata  |
...
| /piattaforma                                       | guarded · AziendeList                   | RequirePiattaforma               | piattaformaRouter.aziende (piattaformaProcedure)             | nessun ruolo: capacità di piattaforma da PLATFORM_ADMIN_EMAILS (WS6 §3.1)    | hidden           | workbench   | — (pannello piattaforma · 09/09)                                          | 09/09 · verifica browser 1440/390 | migrata  |
| /piattaforma/:slug                                 | guarded · AziendaDetail                 | RequirePiattaforma               | piattaformaRouter.azienda (piattaformaProcedure)             | nessun ruolo: capacità di piattaforma da PLATFORM_ADMIN_EMAILS (WS6 §3.1)    | hidden deep link | record      | — (scheda azienda · Task 9)                                               | —                                 | migrata  |
