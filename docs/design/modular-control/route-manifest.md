...
| /fatturazione                                      | page · Fatturazione                     | capability:contratto.read        | fatturazioneGuidataRouter + procedureConInterruttore(limiti) | contratto.read; hidden with FLAG_LIMITI off                                  | primary          | standard    | — (fatturazione guidata, piano 4 · 05/09)                                 | 05/09            | migrata  |
