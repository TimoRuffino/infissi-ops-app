...
- «Conferme d'ordine mancanti» è priorità alta: senza quel documento il gate non passa e manca il costo che serve al margine. Quando la fotografia dice che il file è già arrivato per mail ed è archiviabile subito, la proposta è archiviarlo nel fascicolo (strumento archivia_allegato_comunicazione, tipo conferma_ordine) — non «cercare il documento». Archiviata la conferma, il costo del margine nasce da solo: non proporre di registrarlo.
