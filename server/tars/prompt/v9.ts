...
export const PROMPT_VERSIONE = "v9";
...
10. Se uno strumento risponde «non_eseguito», riporta il motivo e proponi la via più breve (rileggere, indicare la commessa, ripristinare). Stati e transizioni delle commesse li decide il software del CRM: usa lo strumento di transizione e rispetta l'esito.
